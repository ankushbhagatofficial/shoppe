      ...
      <button onClick={() => router.replace("/")} className="fixed cursor-pointer top-2 left-2 flex items-center justify-center p-2 rounded-full bg-neutral-700">
        ...
        <motion.div initial={{ y: 600, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.5 }} className="bg-neutral-800 rounded-xl w-200 max-w-[90dvw] p-10">
          <div className="flex flex-col justify-center items-center gap-y-10 font-poppins">
            <h1 className="text-xl md:text-2xl font-bold select-none">Please select your role</h1>
            <div className="flex flex-col md:flex-row gap-10">
              <div className="flex flex-col">
                <label>
                  ...
                  <div className="flex flex-col justify-center items-center text-gray-300 bg-neutral-700 w-40 h-30 md:w-40 md:h-40 lg:w-50 lg:h-50 rounded-xl border-3 border-transparent hover:border-yellow-500 peer-checked:text-yellow-400 peer-checked:border-3 peer-checked:border-yellow-500 transition-all duration-200">
              ...
              <div className="flex flex-col">
                <label>
                  ...
                  <div className="flex flex-col justify-center items-center text-gray-300 bg-neutral-700 w-40 h-30 md:w-40 md:h-40 lg:w-50 lg:h-50 rounded-xl border-3 border-transparent hover:border-green-500 peer-checked:text-green-400 peer-checked:border-3 peer-checked:border-green-500 transition-all duration-200">
              ...
              <div className="flex flex-col">
                <label>
                  ...
                  <div className="flex flex-col justify-center items-center text-gray-300 bg-neutral-700 w-40 h-30 md:w-40 md:h-40 lg:w-50 lg:h-50 rounded-xl border-3 border-transparent hover:border-red-500 peer-checked:text-red-400 peer-checked:border-3 peer-checked:border-red-500 transition-all duration-200">
