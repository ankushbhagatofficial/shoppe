        ...
        <div className="flex flex-col w-full gap-2">
          ...
          <div className="flex gap-2 items-center">
            <label className="flex">
              <input onChange={(e) => setActive(e.target.checked)} defaultChecked={category?.active} className="hidden peer rounded outline-0 border-2 border-white/20 focus:border-white/80 text-sm h-10" type="checkbox" name="active" />
